        ...
        SliverToBoxAdapter(
          ...
          child:
            ...
            ...widget.rankedDestinations.asMap().entries.map((e) => Padding(
                  ...
                  child:
                      _DestCard(rank: e.key + 1, scored: e.value, theme: theme),
                )),
            const SizedBox(height: 24),
            SizedBox(
...
class _DestCard extends StatelessWidget {
  ...
  const _DestCard(
      {required this.rank, required this.scored, required this.theme});
            ...
            child:
              ...
              Row(children: [
                Container(
                  ...
                  height: 36,
                  decoration: BoxDecoration(
                      color: rankColors[rank - 1], shape: BoxShape.circle),
                  child: Center(
                      child: Text('#$rank',
